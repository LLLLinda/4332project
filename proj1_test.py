...
####################CNN-LTSM Model#########################
    ...
    train_data_matrix_split=split(train_data_matrix,5000)
    train_data_label_split=split(train_data_label,5000)
    ...
    for i in range(total_epoch):
        ...
        for j in range(20):
            model.fit(train_data_matrix[j], train_data_label[j], epochs=1, batch_size=batch_size)
